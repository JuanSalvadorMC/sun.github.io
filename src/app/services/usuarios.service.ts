...
export class UsuariosService {
  ...
  catTipoNegocio=[
    ...
    catTipoSocio=[
      {idTipoSocio:1, tipoSocio: 'Comunidad de Bienes', descripcion:'Es la fórmula más adecuada cuando la propiedad de un bien o derecho pertenece proindiviso a varias personas y forma parte de una actividad empresarial realizada en común, por ejemplo, el alquiler de viviendas y locales. La comunidad de bienes no tributa por las rentas obtenidas, sino que éstas se atribuyen a los comuneros que las liquidan por IRPF o el Impuesto de Sociedades, principalmente.'},
      {idTipoSocio:2, tipoSocio: 'Sociedad Anónima Laboral', descripcion:'La mayoría del capital social es propiedad de los trabajadores que prestan en ella servicio retribuido y personal con carácter indefinido, si bien en este caso su fórmula es más adecuada para proyectos con mayores perspectivas de crecimiento.'},
      {idTipoSocio:3, tipoSocio: 'Sociedad Civil', descripcion:'Se trata de un contrato por el que dos o más personas ponen en común capital con propósito de repartir entre sí las ganancias. Su tributación debe ser en el Impuesto de Sociedades cuando tienen un objetivo mercantil, y cuando no es así se atribuyen al régimen al que se acoja cada uno de sus socios'},
      {idTipoSocio:4, tipoSocio: 'Sociedad Colectiva', descripcion:'Sociedad mercantil de carácter personalista, en la que todos los socios, en nombre colectivo y bajo una razón social, se comprometen a participar en la proporción que establezcan, de los mismos derechos y obligaciones.'},
      {idTipoSocio:5, tipoSocio: 'Sociedad Comanditaria por Acciones', descripcion:'Su capital social se divide en acciones formadas por las aportaciones de los socios. Uno de los socios debe asumir la administración de la sociedad, respondiendo personalmente de las deudas sociales como socio colectivo.'},
      {idTipoSocio:6, tipoSocio: 'Sociedad Comanditaría Simple', descripcion:'Su peculiaridad es la existencia de socios colectivos que aportan capital y trabajo y responden subsidiaria, personal y solidariamente de las deudas sociales, y de socios comanditarios, que solamente aportan capital, limitando su responsabilidad a esta aportación.'},
      {idTipoSocio:7, tipoSocio: 'Sociedad de Responsabilidad Limitada', descripcion:'Es el tipo de sociedad mercantil más popular, porque evita responder con el patrimonio personal. Divide su capital social en participaciones, que son indivisibles y acumulables. De este modo, está integrada por las aportaciones de todos los socios.'},
      {idTipoSocio:8, tipoSocio: 'Sociedad de Responsabilidad Limitada Laboral', descripcion:'Su principal característica es que al menos el 51% del capital social es propiedad de los trabajadores que prestan en ella servicios retribuidos de forma personal y directa, y con una relación laboral indefinida.'},
      {idTipoSocio:9, tipoSocio: 'Socio Capitalista', descripcion:'Persona que aporta su capital a una empresa o sociedad mercantil, con objeto de participar en las ganancias futuras, especialmente cuando hay uno o varios socios industriales, pero habitualmente no participa en la gestión de la compañía.'}
      ]
